...
// visualizer10Dlg.cpp : implementation file
//

#include "stdafx.h"
#include "visualizer10.h"
#include "visualizer10Dlg.h"
...
// Cvisualizer10Dlg dialog



Cvisualizer10Dlg::Cvisualizer10Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_VISUALIZER10_DIALOG, pParent)
	, channelStr(_T(""))
	, widthStr(_T(""))
	, heightStr(_T(""))
	, multisamplingStr(_T(""))
...
void Cvisualizer10Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(Cvisualizer10Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &Cvisualizer10Dlg::OnBnClickedOk)
	ON_CBN_SELCHANGE(IDC_COMBO1, &Cvisualizer10Dlg::OnCbnSelchangeCombo1)
	ON_EN_CHANGE(IDC_EDIT1, &Cvisualizer10Dlg::OnEnChangeEdit1)
	ON_EN_CHANGE(IDC_EDIT2, &Cvisualizer10Dlg::OnEnChangeEdit2)
	ON_CBN_SELCHANGE(IDC_COMBO2, &Cvisualizer10Dlg::OnCbnSelchangeCombo2)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER1, &Cvisualizer10Dlg::OnNMCustomdrawSlider1)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER2, &Cvisualizer10Dlg::OnNMCustomdrawSlider2)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER6, &Cvisualizer10Dlg::OnNMCustomdrawSlider6)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER7, &Cvisualizer10Dlg::OnNMCustomdrawSlider7)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER8, &Cvisualizer10Dlg::OnNMCustomdrawSlider8)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER9, &Cvisualizer10Dlg::OnNMCustomdrawSlider9)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER10, &Cvisualizer10Dlg::OnNMCustomdrawSlider10)
	ON_BN_CLICKED(IDC_CHECK1, &Cvisualizer10Dlg::OnBnClickedCheck1)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER11, &Cvisualizer10Dlg::OnNMCustomdrawSlider11)
	ON_BN_CLICKED(IDC_CHECK4, &Cvisualizer10Dlg::OnBnClickedCheck4)
	ON_BN_CLICKED(IDC_CHECK5, &Cvisualizer10Dlg::OnBnClickedCheck5)
	ON_BN_CLICKED(IDC_CHECK6, &Cvisualizer10Dlg::OnBnClickedCheck6)
	ON_BN_CLICKED(IDC_CHECK2, &Cvisualizer10Dlg::OnBnClickedCheck2)
	ON_BN_CLICKED(IDC_CHECK3, &Cvisualizer10Dlg::OnBnClickedCheck3)
	ON_BN_CLICKED(IDC_CHECK7, &Cvisualizer10Dlg::OnBnClickedCheck7)
	ON_BN_CLICKED(IDC_CHECK8, &Cvisualizer10Dlg::OnBnClickedCheck8)
	ON_BN_CLICKED(IDC_CHECK9, &Cvisualizer10Dlg::OnBnClickedCheck9)
	ON_BN_CLICKED(IDC_CHECK10, &Cvisualizer10Dlg::OnBnClickedCheck10)
	ON_CBN_SELCHANGE(IDC_COMBO6, &Cvisualizer10Dlg::OnCbnSelchangeCombo6)
	ON_CBN_SELCHANGE(IDC_COMBO5, &Cvisualizer10Dlg::OnCbnSelchangeCombo5)
	ON_CBN_SELCHANGE(IDC_COMBO4, &Cvisualizer10Dlg::OnCbnSelchangeCombo4)
	ON_CBN_SELCHANGE(IDC_COMBO3, &Cvisualizer10Dlg::OnCbnSelchangeCombo3)
	ON_CBN_SELCHANGE(IDC_COMBO7, &Cvisualizer10Dlg::OnCbnSelchangeCombo7)
END_MESSAGE_MAP()


// Cvisualizer10Dlg message handlers

BOOL Cvisualizer10Dlg::OnInitDialog()
{
	...
	colourStr = L"Rainbow";
	shapeBox.SetCurSel(0);
	shapreStr = L"DRAW";

	return TRUE;  // return TRUE  unless you set the focus to a control
}

void Cvisualizer10Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR Cvisualizer10Dlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

void Cvisualizer10Dlg::OnBnClickedOk()
{
	// set window values
...
void Cvisualizer10Dlg::OnBnClickedButton1()
{
	CWnd *label = GetDlgItem(IDC_STATIC);
	label->SetWindowText(channelStr);
}

void Cvisualizer10Dlg::OnCbnSelchangeCombo1()
{
	channelBox.GetLBText(channelBox.GetCurSel(), channelStr);
}

void Cvisualizer10Dlg::OnEnChangeEdit1()
{
	widthBox.GetWindowText(widthStr);
}

void Cvisualizer10Dlg::OnEnChangeEdit2()
{
	heightBox.GetWindowText(heightStr);
}

void Cvisualizer10Dlg::OnCbnSelchangeCombo2()
{
	multisamplingBox.GetLBText(multisamplingBox.GetCurSel(), multisamplingStr);
}

void Cvisualizer10Dlg::OnNMCustomdrawSlider1(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void Cvisualizer10Dlg::OnNMCustomdrawSlider2(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMCUSTOMDRAW pNMCD = reinterpret_cast<LPNMCUSTOMDRAW>(pNMHDR);
...
void Cvisualizer10Dlg::OnNMCustomdrawSlider6(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMCUSTOMDRAW pNMCD = reinterpret_cast<LPNMCUSTOMDRAW>(pNMHDR);
...
void Cvisualizer10Dlg::OnNMCustomdrawSlider7(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMCUSTOMDRAW pNMCD = reinterpret_cast<LPNMCUSTOMDRAW>(pNMHDR);
...
void Cvisualizer10Dlg::OnNMCustomdrawSlider8(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMCUSTOMDRAW pNMCD = reinterpret_cast<LPNMCUSTOMDRAW>(pNMHDR);
...
void Cvisualizer10Dlg::OnNMCustomdrawSlider9(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMCUSTOMDRAW pNMCD = reinterpret_cast<LPNMCUSTOMDRAW>(pNMHDR);
...
void Cvisualizer10Dlg::OnNMCustomdrawSlider10(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMCUSTOMDRAW pNMCD = reinterpret_cast<LPNMCUSTOMDRAW>(pNMHDR);
...
void Cvisualizer10Dlg::OnBnClickedCheck1()
{
	aaVal = aaBox.GetCheck(); 
}

void Cvisualizer10Dlg::OnNMCustomdrawSlider11(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMCUSTOMDRAW pNMCD = reinterpret_cast<LPNMCUSTOMDRAW>(pNMHDR);
...
void Cvisualizer10Dlg::OnBnClickedCheck4()
{
	peakRotateVal = peakRotateBox.GetCheck();
}

void Cvisualizer10Dlg::OnBnClickedCheck5()
{
	peakFovVal = peakFovBox.GetCheck();
}

void Cvisualizer10Dlg::OnBnClickedCheck6()
{
	animTessVal = animTessBox.GetCheck();
}

void Cvisualizer10Dlg::OnBnClickedCheck2()
{
	lightingVal = lightingBox.GetCheck();
}

void Cvisualizer10Dlg::OnBnClickedCheck3()
{
	explodeVal = explodeBox.GetCheck();
}

void Cvisualizer10Dlg::OnBnClickedCheck7()
{
	wireframeVal = wireframeBox.GetCheck();
}

void Cvisualizer10Dlg::OnBnClickedCheck8()
{
	simpleNormsVal = simpleNormsBox.GetCheck();
}

void Cvisualizer10Dlg::OnBnClickedCheck9()
{
	switchNormsVal = switchNormsBox.GetCheck();
}

void Cvisualizer10Dlg::OnBnClickedCheck10()
{
	texSkyVal = texSkyBox.GetCheck();
}

void Cvisualizer10Dlg::OnCbnSelchangeCombo6()
{
	shapeBox.GetLBText(shapeBox.GetCurSel(), shapreStr);
}

void Cvisualizer10Dlg::OnCbnSelchangeCombo5()
{
	colourBox.GetLBText(colourBox.GetCurSel(), colourStr);
}

void Cvisualizer10Dlg::OnCbnSelchangeCombo4()
{
	// TODO: Add your control notification handler code here
}

void Cvisualizer10Dlg::OnCbnSelchangeCombo3()
{
	// TODO: Add your control notification handler code here
}

void Cvisualizer10Dlg::OnCbnSelchangeCombo7()
{
